{
   Please note that the PixelCollideTest function used in this unit was developed
   from the SDL_PixelTest function found in the SDLUtils unit created by:
   Tom Jones <tigertomjones@gmx.de> Copyright (C) 2000 - 2001
   Contributors:
   Dominique Louis <Dominique@SavageSoftware.com.au>
   Róbert Kisnémeth <mikrobi@freemail.hu>

   The main change to the function is the addition of surface locking and removal
   of surface rect calculations
}
unit Tools ;
interface
...
const
 ...
 //  kFlags = SDL_HWPALETTE or SDL_SWSURFACE ; {run in a window when debugging}
