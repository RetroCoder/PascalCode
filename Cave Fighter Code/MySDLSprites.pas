{
   Some of the code in this unit is based on sdlsprites.pas
}
...
uses
   Classes, SysUtils, sdl_image, sdl, Tools, CFconsts ;
...
begin
   ...
   begin
   //   ASSERT (false) ;  {a sprite with no FigureSurface is bad news}
      FigureSurface := nil ;
   end ;
...
begin
 //  Dispose (SrcRect) ; Free it on the destroy
