...
begin
   ...
   if m_iFrameCount < 15 then // was <> 15
   begin
      inc (m_iFrameCount) ;
   end
   else
   begin
      ...
      begin
         ...
         m_StatObj.SetLevel (ARecord^.Level, m_dataPointer) ;
...
procedure TDataEngine.WonGameReSet ;
begin
   Init ;
end ;
