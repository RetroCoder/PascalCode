...
uses
   FileUtil, SDL, SDL_Image, CFconsts, sysutils ;
...
begin
   ...
   if FileExistsUTF8(kHiFileName) { *Converted from FileExists*  } and (not FileIsReadOnlyUTF8(kHiFileName) { *Converted from FileIsReadOnly*  }) then
   begin
...
begin
   ...
   if not FileExistsUTF8(kHiFileName) { *Converted from FileExists*  } then
   begin
      DoTheSave ;
   end
   else if not FileIsReadOnlyUTF8(kHiFileName) { *Converted from FileIsReadOnly*  } then
   begin
      DoTheSave ;
   end ;
end ;
